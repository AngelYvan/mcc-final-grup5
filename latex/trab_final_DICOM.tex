...
En el diseño del código se ha trabajado contando como referencias las librerías “Medical Imaging Interaction Toolkit (MITK) debido a la facididad para el manejo de las imagenes en formatp DICOM,  con la finalidad de ofrecer una mejor interfaz.
